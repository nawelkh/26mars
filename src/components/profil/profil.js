...
function Profil (){ 
  ...
  .then((res) => { 
    ...
    console.log(`email est ${email}`);
      //nom: user.credentials.nom,
     //prenom:user.credentials.prenom,
    //formation: user.credentials.formation,
     // createdat: new Date().toISOString(),
     // imageUrl: `https://firebasestorage.googleapis.com/v0/b/${config.storageBucket}/o/${noImg}?alt=media`,
     //userId :user.credentials.uid} 
  })
            ...
            <div>
                  ...
                  >
                    ...
                    <form className={classes.root2}>
                            <TextField size="small"  variant="outlined" label="Nom"defaultValue={nom} />
                            <TextField size="small"  variant="outlined" label="Prénom"defaultValue={prenom} />
